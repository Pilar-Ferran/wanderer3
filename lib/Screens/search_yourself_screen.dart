...
class SearchYourselfScreen extends StatefulWidget {
  static const routeName = '/search_yourself_screen';

  const SearchYourselfScreen({Key? key}) : super(key: key);
  @override
  _SearchYourselfScreenState createState() => _SearchYourselfScreenState();
}
...
class _SearchYourselfScreenState extends State<SearchYourselfScreen> {
  List _allResults = [];
  List _resultsList = [];
                  ...
                  Expanded(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            Text(userMapUid!['followers'].toString(),
                              style: const TextStyle(color: Colors.black,
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold),),
                            const SizedBox(height: 5),
                        ...
                        Column(
                          children: [
                            Text(userMapUid!['following'].toString(),
                              style: const TextStyle(color: Colors.black,
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold),),
                            const SizedBox(height: 5),
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text(userMapUid!['username'], style: const TextStyle(
                            color: Colors.black,
                            fontSize: 20,
                            fontWeight: FontWeight.bold),),
                        SizedBox(
                        ...
                        Text(userMapUid!['biography'], style: const TextStyle(
